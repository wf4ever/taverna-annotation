package org.purl.wf4ever.taverna.annotation;
...
public class AnnotationActivity extends
		AbstractAsynchronousActivity<AnnotationActivityConfigurationBean>
		implements AsynchronousActivity<AnnotationActivityConfigurationBean> {
	...
	private AnnotationActivityConfigurationBean configBean;

	@Override
	public void configure(AnnotationActivityConfigurationBean configBean)
...
//					callback.fail("Could not invoke Annotation service " + configBean.getExampleUri(),
//							ex);
...
//				}
	...
	@Override
	public AnnotationActivityConfigurationBean getConfiguration() {
